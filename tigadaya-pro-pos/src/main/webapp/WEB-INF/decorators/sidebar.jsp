	...
	<section class="sidebar">
		...
		<div class="user-panel">
			<div class="pull-left image">
				<img src="${contextName}/resources/dist/img/java.jpg" class="img-circle"
					alt="User Image">
			</div>
		...
		<ul class="sidebar-menu" data-widget="tree">
			...
			<li class="active treeview"><a href="#"> <i
					class="fa fa-table"></i> <span>Master Data</span> <span
			...
			<li><a href="https://github.com/evanderfilipi" target="_blank"><i class="fa fa-book"></i>
