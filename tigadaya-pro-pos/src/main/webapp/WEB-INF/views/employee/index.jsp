...
<form id="form-create">
	<div class="box box-info">
		...
		<div class="box-body">
			<div class="row">
				<div class="col-md-3">
					<input type="text" class="form-control" name="employee[firstName]"
						id="firstName" placeholder="First Name" />
				</div>
				<div class="col-md-3">
					<input type="text" class="form-control" name="employee[lastName]"
						id="lastName" placeholder="Last Name" />
				</div>

				<div class="col-md-3">
					<input type="email" class="form-control" name="employee[email]" id="email"
						placeholder="Email" />
				</div>

				<div class="col-md-3">
					<select name="employee[title]" id="title" class="form-control">
			...
			<div class="row">
				...
				<div class="col-md-3">
					<input type="checkbox" name="employee[haveAccount]" value="true"
			...
			<div class="row" id="row-role" style="display:none;">
				<div class="col-md-3">
					<select id="roleId" name="user[roleId]" class="form-control">
				...
				<input type="hidden" class="form-control" name="employee[active]" value="true" />
				<input type="hidden" class="form-control" name="user[active]" value="true" />
